...
bibliography: horse_pop_ref.bib
params:
  province: "Alberta"
output:
  github_document:
...
knitr::kable(max_horses,
      caption = "Table 1. Maximum and minimum number horses for \
      each province between 1940 - 1972")
```

Below we zoom in and look at the province of Alberta:

```{r plot province, fig.width=6, fig.height=4, fig.cap = "Figure 2. Number of horses for province of focus", out.width = "50%"}
